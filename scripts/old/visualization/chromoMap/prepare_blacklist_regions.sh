...
similar_regions="${workdir}/1.mapping_cleaning/output/vector_similar_regions_to_remove.bed"
...
awk '{print "similar\t",$0}' $similar_regions > $workdir/visualization/chromoMap/input/vector/vector_similar_regions_to_remove.tmp
awk '{print "repeat\t",$0}' $repeat_regions > $workdir/visualization/chromoMap/input/vector/vector_repeat_regions_to_remove.tmp
cat $workdir/visualization/chromoMap/input/vector/vector_similar_regions_to_remove.tmp $workdir/visualization/chromoMap/input/vector/vector_repeat_regions_to_remove.tmp > $workdir/visualization/chromoMap/input/vector/vector_blacklist_regions.bed
