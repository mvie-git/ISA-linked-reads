...
data <- read.delim("/home/mallaury/Bureau/phd/PROJECT/GSDIa_louisa/ISA/visualization/chromoMap/input/mouse/mouse_blacklist_regions.bed", header=FALSE)
...
write.table(x = chromosome, file ="/home/mallaury/Bureau/phd/PROJECT/GSDIa_louisa/ISA/visualization/chromoMap/input/chromosome.txt", sep="\t", col.names=FALSE, row.names=FALSE)
write.table(x = annotation, file ="/home/mallaury/Bureau/phd/PROJECT/GSDIa_louisa/ISA/visualization/chromoMap/input/annotation.txt", sep="\t", col.names=FALSE, row.names=FALSE)
...
chromoMap("/home/mallaury/Bureau/phd/PROJECT/GSDIa_louisa/ISA/visualization/chromoMap/input/chromosome.txt", 
          "/home/mallaury/Bureau/phd/PROJECT/GSDIa_louisa/ISA/visualization/chromoMap/input/annotation.txt", 
          segment_annotation = T,
