...
workdir <- "/home/mallaury/Bureau/phd/PROJECT/GSDIa_louisa/ISA/visualization/karyoploteR/input/mouse/IS_chimeric_reads/short/"
mouse_genome <- "/home/mallaury/Bureau/phd/PROJECT/GSDIa_louisa/ISA/visualization/karyoploteR/input/mouse/mouse_genome.txt"
sample <- list.files(path="/home/mallaury/Bureau/phd/PROJECT/GSDIa_louisa/ISA/visualization/karyoploteR/input/mouse/IS_chimeric_reads/short/", pattern="*_mouse_chimeric_IS.bed")
...
karyoploteR_IS_plot <- function(workdir, color, path_to_data, pos0, pos1) {
  ...
  # Add IS data
  kp.IS <- kpPlotRegions(kp, data=extendRegions(IS.data, extend.end = 2e6), col=color, layer.margin = 0.1, border=NA, r0=pos0, r1=pos1)
