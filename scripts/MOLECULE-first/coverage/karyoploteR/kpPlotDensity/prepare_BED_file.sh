...
workdir="/media/mallaury/MALLAURY1/PROJECT/GSDIa_ISA/hybrid_genome_mapping/karyoploteR/kpPlotDensity" #----------------------> !CHANGE IT!#
...
while read sample; do
	...
	input_BAM=/media/mallaury/MALLAURY1/PROJECT/GSDIa_ISA/hybrid_genome_mapping/output/${sample}/${sample}_mapping_mouseANDvector.sorted.mapped.mouse.bam
	...
	$sambamba markdup -r -t $nb_threads -p $input_BAM /media/mallaury/MALLAURY1/PROJECT/GSDIa_ISA/hybrid_genome_mapping/output/${sample}/${sample}_mapping_mouseANDvector.sorted.mapped.mouse.no_duplicates.bam
	...
	bedtools bamtobed -i /media/mallaury/MALLAURY1/PROJECT/GSDIa_ISA/hybrid_genome_mapping/output/${sample}/${sample}_mapping_mouseANDvector.sorted.mapped.mouse.no_duplicates.bam > ${workdir}/input/${sample}.tmp
